...
export default function StudentProjectDetail() {
  ...
  const { data: project } = useQuery({
    ...
    queryFn: async () => {
      const result = await base44.entities.ProjectTemplate.filter({ id: projectId });
      return result[0];
    },
    enabled: !!projectId,
  });
  ...
  const { data: submission, refetch: refetchSubmission } = useQuery({
    queryKey: ['my-project-submission', projectId],
    queryFn: async () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-8">
      <div className="max-w-4xl mx-auto">
        <Button variant="ghost" onClick={() => navigate(createPageUrl('StudentProjects'))} className="mb-6">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm mb-6">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <Badge variant="outline" className="mb-2">Week {project.week_number}</Badge>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Describe your project, approach, and outcomes..."
                    rows={8}
                ...
                <div>
                  ...
                  <div className="mt-2">
                    {!isSubmitted && (
                      <label className="flex items-center gap-2 px-4 py-3 border-2 border-dashed border-slate-300 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-all cursor-pointer">
