...
import { Mail, Phone, Award, Upload } from 'lucide-react';
...
export default function TutorProfile() {
  ...
  const { data: tutorAssignments = [] } = useQuery({
    queryKey: ['my-tutor-assignments'],
    queryFn: () => base44.entities.TutorCohortAssignment.filter({ tutor_id: user?.id }),
    enabled: !!user?.id,
  });
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-8">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage your tutor profile</p>
        </div>
            ...
            <div className="flex flex-col items-center text-center">
              <div className="relative mb-4">
                {user?.profile_picture_url ? (
                  ...
                  <div className="w-32 h-32 rounded-full bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center text-white text-4xl font-bold">
              ...
              <p className="text-slate-500 mt-2">Manage your profile and teaching preferences</p>
            </div>
          </CardContent>
        </Card>
              ...
              <CardContent className="pt-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-slate-700">Active Cohorts</p>
                      <p className="text-sm text-slate-600">{tutorAssignments.length} cohorts</p>
                    </div>
                  </div>
                </div>
              </CardContent>
